...
app.post("/create-setup-intent", async (req, res) => {
  ...
  const customer = await stripe.customers.create({ "name": "nathan", "email": "nathantest@gmail.com" });
...
//     amount: 1099,
//     currency: 'usd',
//     customer: "cus_IK59SFTewE3d20",
//   });
//   return res.json(intent);
// })

app.get("/get-customer", async (req, res) => {
  res.json({ customerId: "cus_IKMOZ5kM3ltTPZ" });
})

app.post("/attach-card", async (req, res) => {
...
app.post("/create-payment-intent", async (req, res) => {
  ...
  return res.json({ message: `Payment Intent confirmed for ${req.body.customerId} and charge will be initialized soon` })
})
